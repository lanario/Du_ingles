  ...
  public: {
    Tables: {
      ...
      learning_objectives: {
        ...
        Relationships: [
          {
            foreignKeyName: "learning_objectives_completed_by_fkey"
          ...
          {
            foreignKeyName: "learning_objectives_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "learning_objectives_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "learning_objectives_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
